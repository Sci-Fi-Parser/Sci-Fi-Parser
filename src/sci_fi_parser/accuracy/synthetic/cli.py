...
def _parse_args() -> argparse.Namespace:
    ...
    ap.add_argument("--preview", action="store_true",
                    help="one sample per catalog type into <out>/preview, then exit")
    ...
    ap.add_argument("--refresh", action="store_true",
                    help="delete prior outputs in --out before generating")
...
def _print_summary(args: argparse.Namespace, img_dir: Path, dbg_dir: Path,
                   counts: dict, n_total: int) -> None:
