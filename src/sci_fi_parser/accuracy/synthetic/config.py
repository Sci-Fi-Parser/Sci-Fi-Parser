...
CATALOG: dict[str, dict] = {
    "simple": {"chart_type": "bar_chart", "family": "bar", "orientation": "v",
               "stacked": False, "color": "single", "series": 1},
    "multicolor": {"chart_type": "bar_chart", "family": "bar", "orientation": "v",
                   "stacked": False, "color": "colormap", "series": 1},
    "grouped": {"chart_type": "grouped_bar_chart", "family": "bar", "orientation": "v",
                "stacked": False, "color": "series", "series": "multi"},
    "stacked": {"chart_type": "stacked_bar_chart", "family": "bar", "orientation": "v",
                "stacked": True, "color": "series", "series": "multi"},
    "horizontal": {"chart_type": "horizontal_bar_chart", "family": "bar",
                   "orientation": "h", "stacked": False, "color": "single", "series": 1},
    "line": {"chart_type": "line_chart", "family": "line", "orientation": "v",
             "stacked": False, "color": "series", "series": 1},
    "2-line": {"chart_type": "line_chart", "family": "line", "orientation": "v",
               "stacked": False, "color": "series", "series": 2},
    "3-line": {"chart_type": "line_chart", "family": "line", "orientation": "v",
               "stacked": False, "color": "series", "series": 3},
    "multiline": {"chart_type": "line_chart", "family": "line", "orientation": "v",
                  "stacked": False, "color": "series", "series": "multi"},
}
